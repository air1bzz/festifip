var bands = {
  ...
  morin: {
    title: "L’AGENCE DE VOYAGE MORIN",
    desc: "Mic Mac Cie",
  ...
  lions: {
    title: 'DES LIONS POUR DES LIONS',
  ...
  nefertiti: {
    title: 'NEFERTITI IN THE KITCHEN',
...
function bandMain (bandTag) {
  ...
  // Change color
  if (lastElem) {
    lastElem.style.color = '#CB6829'
  }
  navElem.style.color = '#DFC124'
  lastElem = navElem
}
